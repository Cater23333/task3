        ...
        for idx, img in enumerate(L_paths):
            ...
            for i in range(len(seq)):
                ...
                for u in range(iter_num_U):
                    ...
                    if 'DPS' in generate_mode:
                        ...
                        print(666)
                        #print(model)
                        '''model1 = utils_model.DiffPIR(noise_level=curr_sigma * 255,
                        ...
                        y = torch.rand(3,3,128)
                        #model.parameters()
                        y=y.to(device)
                        model_dict = model.state_dict()
                        model_dict['timesteps']=0.1
                        print(model.image_size)
                        print(model.in_channels)
                        print(model.model_channels)
                        print(model.out_channels)
                        print(model.num_res_blocks)
                        print(model.attention_resolutions)
            ...
            if save_progressive:
                ...
                util.imsave(img_total * 255., os.path.join(E_path,
                                                           img_name + '_sigma_{:.3f}_process_lambda_{:.3f}_{}_psnr_{:.4f}.png'.format(
